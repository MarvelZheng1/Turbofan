...
function BDLC_plotSingle(blade, type, plot_throat, plot_t_max, plot_bez_p1, LE_align, show_curvature, flip_stator, num_blades, profiles_to_plot, pitch_align, highlight)
    ...
    counter = 1;
    for i = profiles_to_plot            
        BDLC_plotProfile(blade(i), plot_throat, plot_t_max, plot_bez_p1, show_curvature, lineStyle)
