function flow_field = free_vortex_IGV(rps, r_hub_vec_stages, r_tip_vec_stages, ang_vel, degR_m, rho_m_vec_stages, cp, R, T0_stages, m_dot_target, e_c, gamma)
    %% ======== Initial Values ========
    ...
    % degR_spans = cell(1, full_vec_length);
    ...
    for s = 1:numel(r_tip_vec_stages)-1
        % ======== Upstream of Rotor ========
    ...
    function degR_span = degR_span(b, ang_vel, r_mean, degR_m)
        degR_span = (1-b/ang_vel) - ((1-b/ang_vel)-degR_m)/((r/r_mean).^2);
    end
