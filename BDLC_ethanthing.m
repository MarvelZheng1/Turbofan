...
for i = 1:num_samples
    blade_params =  BDLC_IFN.blade_parameters(R, R_LE, R_TE, Cx_space(i), ttc_space(i), zeta, beta_IN, ep_IN, beta_OUT, ep_OUT, N_B_space(i), blade_height, V_mag_mid, "Rotor", resolution, iteration_threshold);
