...
function blade = BDLC_pritchard(params)
    failcode = "success!!";
    max_iter = 300;
    ...
    while factor > params.iteration_threshold
        [pts, failcode] = BDLC_pritchardPoints(params.R, params.R_LE, params.R_TE, params.Cx, params.Ct, params.zeta, params.beta_IN, params.ep_IN, params.beta_OUT, params.ep_OUT, params.N_B, o);
        try
            blade = BDLC_pritchardCurves(pts.x_coords, pts.y_coords, pts.betas, params.R_LE, params.R_TE, o, params.res);
        catch
