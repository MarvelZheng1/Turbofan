...
function BDLC_plotSet(rotor_blade, stator_blade, plot_throat, plot_t_max, plot_bez_p1, LE_align, show_curvature, flip_stator, num_stator, num_rotor, profiles_to_plot, pitch_align)
    ...
    counter = 1;
    for i = profiles_to_plot            
        BDLC_plotProfile(stator_blade(i), plot_throat, plot_t_max, plot_bez_p1, show_curvature, '-k')
        [min_ys(counter), max_ys(counter)] = maxmin_y(stator_blade(i));
        counter = counter + 1;
        BDLC_plotProfile(rotor_blade(i), plot_throat, plot_t_max, plot_bez_p1, show_curvature, '-k')
